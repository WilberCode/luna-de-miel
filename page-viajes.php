	...
	<section id="main" class="clearfix page-posts">
		<div class="container">
				...
				<?php
					...
					if ($listing->have_posts()) :
						while ($listing->have_posts()) : $listing->the_post();
							...
							echo '<a href="' . get_permalink() . '" class="thumbnail" ><img src="' . $imagethumb . '" alt="'.get_the_title().'"/> <h2  class="" >'.get_the_title().'</h2>';
							echo '</a>'; 
							echo '</div>'; 
						endwhile;
					endif;
			...
			<div class="col-xs-12 col-md-12 text-center">
				<a class="btn btn-default btn-lg" href="/todos-viajes/" role="button">Ver todos los viajes</a>
			</div>	
		</div>
	</section>		
	<?php endwhile; endif; ?>

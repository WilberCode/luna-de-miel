	...
	<div class="col-main col-sm-8">
		<?php if (get_post_status()=='archive'){ ?>
			<div class="alert alert-warning" role="alert">
			  Esta entrevista ya no se encuentra disponible. Te invitamos a que visites <a href="/entrevistas/" class="alert-link">nuestra sección de entrevistas</a>.
			</div>
		<?php } ?>
			...
			<?php
					...
					if ($listing->have_posts()) :
						while ($listing->have_posts()) : $listing->the_post();
							...
							$terms = wp_get_post_terms( $listing->post->ID, array( 'catentrevistas' ) ); 
